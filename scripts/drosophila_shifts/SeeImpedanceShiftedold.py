...
f_medium = 2 #Hz
f_gain = 10 #Hz, when gain is measured in gain_f
option = 2
...
for i,V in enumerate(Vr):
    ...
    Bandwidth[i] = Calculate_Bandwidth(Z_cut,f_from_medium)
    ...
    if V > V_rest :
        ...
        gain_f[i] = abs(photoreceptor.body.voltage_contrast_gain(f_gain))
    ...
    gain_f_shift[i] = abs(photoreceptor_shifted.body.voltage_contrast_gain(f_gain))
    ...
    Bandwidth_shift[i] = Calculate_Bandwidth(Z_cut,f_from_medium)
